<template>
      ...
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['company:head:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['company:head:export']"
          >导出</el-button>
        </el-col>
  ...
  <script>
  import { listHead, getHead, delHead, addHead, updateHead } from "@/api/company/head";
  ...
  export default {
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('company/head/export', {
          ...this.queryParams
