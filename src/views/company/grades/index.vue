<template>
      ...
      <el-row :gutter="10" class="mb8">
        ...
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['college:grades:edit']"
          >修改</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['college:grades:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['college:grades:export']"
          >导出</el-button>
        </el-col>
    ...
    <!--     <el-table-column label="出勤成绩" align="center" prop="cq1Grages" />
        ...
        <el-table-column label="出勤成绩" align="center" prop="cq2Grades" />
        <el-table-column label="工作态度成绩" align="center" prop="at2Grades" />
        <el-table-column label="实习日志成绩" align="center" prop="log2Grades" />
        <el-table-column label="团队协助成绩" align="center" prop="team2Grades" />
        <el-table-column label="综合成绩" align="center" prop="score1" />
