<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="实习岗位" prop="name">
        <el-input
    ...
    <el-table v-loading="loading" :data="informationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="实习岗位" align="center" prop="name" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        <el-form-item label="实习岗位" prop="name">
          <el-input v-model="form.name" placeholder="请输入实习岗位" />
        </el-form-item>
        ...
        <el-form-item label="所需专业" prop="major">
          <el-input v-model="form.major" placeholder="请输入所需专业" />
        </el-form-item>
        <el-form-item label="联系人" prop="contract">
...
<script>
import { listInformation, getInformation, delInformation, addInformation, updateInformation } from "@/api/internship/information";
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除实习信息发布编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('internship/information/export', {
        ...this.queryParams
