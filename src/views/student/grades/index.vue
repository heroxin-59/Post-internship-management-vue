<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label-width="120px"	 label="实习单位负责人" prop="companyTeacher">
        <el-input
    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['student:grades:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['student:grades:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['student:grades:export']"
        >导出</el-button>
      </el-col>
    ...
    <el-table v-loading="loading" :data="gradesList" @selection-change="handleSelectionChange">
      ...
      <el-table-column width="120px" label="实习单位负责人" align="center" prop="companyTeacher" />
...
<script>
import { listGrades, getGrades, delGrades, addGrades, updateGrades } from "@/api/student/grades";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('student/grades/export', {
        ...this.queryParams
