<template>
    <div class="app-container">
      <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
        <el-form-item label="专业" prop="deptId">
          <el-select v-model="queryParams.deptId" placeholder="请选择专业" clearable>
            <el-option
      ...
      <el-row :gutter="10" class="mb8">
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleAdd"
            v-hasPermi="['college:student:add']"
          >新增</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="single"
            @click="handleUpdate"
            v-hasPermi="['college:student:edit']"
          >修改</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            :disabled="multiple"
            @click="handleDelete"
            v-hasPermi="['college:student:remove']"
          >删除</el-button>
        </el-col>
        <el-col :span="1.5">
          <el-button
            ...
            size="mini"
            @click="handleExport"
            v-hasPermi="['college:student:export']"
          >导出</el-button>
        </el-col>
      ...
      <el-table v-loading="loading" :data="studentList" @selection-change="handleSelectionChange">
        ...
        <el-table-column label="专业" align="center" prop="deptId">
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item label="学生昵称" prop="nickName">
            <el-input v-model="form.nickName" placeholder="请输入学生昵称" />
          </el-form-item>
          <el-form-item label="学生邮箱" prop="email">
          ...
          <el-form-item label="专业" prop="deptId">
            <el-select v-model="form.deptId" placeholder="请选择专业">
              <el-option
                v-for="dict in dict.type.internship_major"
                :key="dict.value"
                :label="dict.label"
  ...
  <script>
  import { listStudent, getStudent, delStudent, addStudent, updateStudent } from "@/api/college/student";
  ...
  export default {
    ...
    data() {
      return {
        ...
        rules: {
          ...
          nickName: [
            { required: true, message: "学生昵称不能为空", trigger: "blur" }
          ],
        }
      };
    },
    ...
    methods: {
      ...
      /** 导出按钮操作 */
      handleExport() {
        this.download('college/student/export', {
          ...this.queryParams
